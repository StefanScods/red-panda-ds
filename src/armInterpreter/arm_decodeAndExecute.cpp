/**
 * @file armInterpreter/arm_decodeAndExecute.cpp
 * @brief Implements ARM mode instuction set decoding helpers used in execute.
 */
#include "cpu.h"
...
// ==================================================================================================
cycles ARM::ARM_dataProcessingDecodeAndExecute(uint32_t instruct, uint8_t cond) {
...
// ==================================================================================================
cycles ARM::ARM_loadStoreDecodeAndExecute(uint32_t instruct, uint8_t cond) {
    // Extract useful parts of the instruction in order to decode.
...
// ==================================================================================================
cycles ARM::ARM_branchAndBlockDataTransferDecodeAndExecute(uint32_t instruct, uint8_t cond) {
...
// ==================================================================================================
cycles ARM::ARM_coprocessorAndSupervisorDecodeAndExecute(uint32_t instruct, uint8_t cond) {
    // Extract useful parts of the instruction in order to decode.
    // OpCode.
    uint8_t op1 = readBits(instruct, 20, 25);
